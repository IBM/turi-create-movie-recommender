...
* [ngrok](https://ngrok.com/): allows you to open an HTTPS tunnel into your REST API.

## Featured technologies

* [Artificial Intelligence](https://www.ibm.com/cloud/watson-studio): Artificial intelligence can be applied to disparate solution spaces to deliver disruptive technologies.
...
* [Turi Create (5.0 Beta 2)](https://github.com/apple/turicreate)
...
Next, open up a tunnel to the backend with [ngrok](https://ngrok.com/), so your iOS App can access it:
